...
precursors_triamines = stk.MoleculeMongoDb(
    mongo_client=client, database='cage_precursors_AB', molecule_collection='Triamines', position_matrix_collection='triamines_postmat',
    jsonizer=stk.MoleculeJsonizer(
        key_makers = (stk.InchiKey(), std_smiles())), indices=('SMILES')
)
precursors_diamines = stk.MoleculeMongoDb(
    mongo_client=client, database='cage_precursors_AB', molecule_collection='Diamines', position_matrix_collection='diamines_postmat',
    jsonizer=stk.MoleculeJsonizer(
        key_makers = (stk.InchiKey(), std_smiles())), indices=('SMILES')
)
precursors_trialdehydes = stk.MoleculeMongoDb(
    mongo_client=client, database='cage_precursors_AB', molecule_collection='Trialdehydes', position_matrix_collection='trialdehydes_postmat',
    jsonizer=stk.MoleculeJsonizer(
        key_makers = (stk.InchiKey(), std_smiles())), indices=('SMILES')
)
precursors_dialdehydes = stk.MoleculeMongoDb(
    mongo_client=client, database='cage_precursors_AB', molecule_collection='Dialdehydes', position_matrix_collection='dialdehydes_postmat',
    jsonizer=stk.MoleculeJsonizer(
        key_makers = (stk.InchiKey(), std_smiles())), indices=('SMILES')
)
